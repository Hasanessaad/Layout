    ...
    <div class="container col-6">
        ...
        <div class="row">
            <div class="col-md-12 text-start">
                ...
                <input type="number" v-if="form !== 'excluir'"  class="form-control" placeholder="Valor em hora"
            ...
            <div class="col-md-12 text-start">
                ...
                <input type="number" v-if="form !== 'excluir'" class="form-control" placeholder="Valor por minuto"
                    v-model="configuracao.valorMinutoMulta">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3">Vagas para motos *</label>
                <input type="number" v-if="form !== 'excluir'" class="form-control" placeholder="Número de vagas"
            ...
            <div class="col-md-12 text-start">
                ...
                <input type="text" v-if="form !== 'excluir'" class="form-control" placeholder="09:00:00"
                    v-model="configuracao.inicioExpediente">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3">Fim Expediente *</label>
                <input type="text" v-if="form !== 'excluir'" class="form-control" placeholder="18:00:00"
                    v-model="configuracao.fimExpediente">
            </div>
            <div class="col-md-6 text-start">
                        <label class="form-label">Gerar desconto*</label>
                        <select v-model="configuracao.gerarDesconto" v-if="form !== 'excluir'"
         ...
         <div class="row mt-3">
            <div class="col-md-3 offset-md-6">
                <div class="d-grid gap-2">
                    <router-link type="button" class="btn btn-primary" to="/configuracao">Voltar
                    </router-link>
                </div>
            </div>
            <div class="col-md-3 ">
...
export default defineComponent({
    ...
    methods: {
        ...
        onClickEditar() {
            ConfiguracaoClient.edit(this.configuracao.id, this.configuracao)
                .then(sucess => {
                    this.configuracao = new Configuracao()
